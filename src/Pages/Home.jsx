...
const WORDS = ["Software Analysis & Development student", "Tech Enthusiast"];
const TECH_STACK = ["Java", "Javascript", "Spring Boot", "Tailwind"];
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/EileenLiduenez" },
  { icon: Linkedin, link: "https://www.linkedin.com/in/eileen-lidue%C3%B1ez/" },
  { icon: Instagram, link: "https://www.instagram.com/edlc_123/" }
];
            ...
            <div className="w-full lg:w-1/2 space-y-6 sm:space-y-8 text-left lg:text-left order-1 lg:order-1 lg:mt-0"
              ...
              <div className="space-y-4 sm:space-y-6">
                ...
                <p className="text-base md:text-lg text-gray-400 max-w-xl leading-relaxed font-light"
                  data-aos="fade-up"
                  data-aos-delay="1000">
                  Software developer in constant evolution. I love programming, solving problems and learning new technologies to create impactful digital experiences.
                </p>
